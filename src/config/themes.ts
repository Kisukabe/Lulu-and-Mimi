...
export const THEME_CONFIGS: Record<ThemeVibe, ThemeConfig> = {
  'amber-gold': {
    ...
    btn1Kbd: 'bg-white/60 dark:bg-rose-950 text-[#84231e] dark:text-rose-300 border-rose-300 dark:border-rose-700',
    ...
    btn2Kbd: 'bg-white/60 dark:bg-emerald-950 text-[#1b5e28] dark:text-emerald-300 border-emerald-300 dark:border-emerald-700',
  ...
  'dark-space': {
    ...
    pageBg: 'bg-[#090d16] dark:bg-[#060910]',
    sidebarBg: 'bg-[#0e1626] dark:bg-[#090f1a]',
    sidebarActivePill: 'bg-cyan-500 text-slate-950',
    sidebarActiveText: 'text-slate-950',
    topBarBg: 'bg-transparent',
    ...
    companion1Mascot: '🌙',
    companion2Bg: 'bg-[#111722] dark:bg-[#0c121c]',
    companion2Border: 'border-slate-800 shadow-xl',
    accentColor: '#38bdf8',
  ...
  rose: {
    ...
    sidebarActiveText: 'text-slate-950',
    topBarBg: 'bg-transparent',
    topBarBorder: 'border-rose-950/40',
  ...
  emerald: {
    ...
    sidebarActiveText: 'text-slate-950',
    topBarBg: 'bg-transparent',
    topBarBorder: 'border-emerald-950/40',
  ...
  purple: {
    ...
    sidebarActiveText: 'text-slate-950',
    topBarBg: 'bg-transparent',
    topBarBorder: 'border-purple-950/40',
